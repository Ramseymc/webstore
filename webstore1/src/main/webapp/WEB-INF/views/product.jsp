...
<script src="/webstore1/resources/js/controllers.js"></script>
	...
	<section class="container" ng-app="cartApp">
		<div class="row">
			...
			<div class="col-md-5">
				...
				<p>
					<strong><spring:message code="product.itemCode.label" /></strong><span
				...
				<p>
					<strong><spring:message
							code="product.availUnitsInStock.label" /></strong> :
